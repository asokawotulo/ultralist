...
var (
	blue            = color.New(color.FgBlue, 3)
	blueBold        = color.New(color.FgBlue, color.Bold)
	cyan            = color.New(color.FgCyan, 3)
	magenta         = color.New(color.FgMagenta, 3)
	magentaBold     = color.New(color.FgMagenta, color.Bold)
	red             = color.New(color.FgRed, 3)
	redBold         = color.New(color.FgRed, color.Bold)
	white           = color.New(color.FgWhite, 3)
	whiteBold       = color.New(color.FgWhite, color.Bold)
	yellow          = color.New(color.FgYellow, 3)
